...
{
    class UIAcNumfilterInterface : UIBase
    {
        ...
        {
            //----------------------------------------------------------------------------
            UIAcNumfilterInterface m_parent;
            ...
            //----------------------------------------------------------------------------
            public SumTemp(GameObject go, UIAcNumfilterInterface _parent, int numType)
            {
                m_ObjUI = go;
        ...
        {
            base.Show(arg);
            acNumberData = drawData.acNumberData;
        ...
        public void SetSumPanelView()
        {
            ...
            dictor = from objDic in acNumberData.acNumberDict orderby objDic.Value descending select objDic;
            int i = 0;
        ...
        private void OnBack()
        {
            ...
            Messenger.Broadcast(DgMsgID.DgUI_HideNew, "UIAcNumfilterInterfaceCtrl");
        }
        //----------------------------------------------------------------------------
        private void OnBegin()
        {
            ...
            {
                drawData.resultList = Util.GetAcFilterResult(initialFilterResults, selectTypeList);
                m_totalAfter.text = string.Format(PromptData.GetPrompt("afterFilterTotal"), drawData.resultList.Count);
                UpdateLoopView(drawData.resultList, afterLoopScrollView);
            }
        }
