...
{
    class UINeighborNumFilterInterface : UIBase
    {
        ...
        private NeighborNumberData neighborNumData;
        ...
        {
            //----------------------------------------------------------------------------
            UINeighborNumFilterInterface m_parent;
            GameObject m_ObjUI;
            Transform m_tran;
            ...
            //----------------------------------------------------------------------------
            public SumTemp(GameObject go, UINeighborNumFilterInterface _parent)
            {
                m_ObjUI = go;
        ...
        {
            base.Show(arg);
            neighborNumData = drawData.neighborNumData;
            if (bFirstShow)
            {
                bFirstShow = false;
                SetSumPanelView();
        ...
        {
            foreach (var list in neighborNumData.dict)
            {
                for (int i = 0; i < m_SumTemp.Count; i++)
                {
                    ...
                    if (!neighborNumData.dict.ContainsKey(i))
                    {
            ...
            string str = string.Empty;
            var numberList = neighborNumData.numberList;
        ...
        {
            var numberList = neighborNumData.neighborNumberList;
        ...
        private void OnBack()
        {
            Messenger.Broadcast(DgMsgID.DgUI_HideNew, "UINeighborNumFilterInterfaceCtrl");
        }
        //----------------------------------------------------------------------------
        ...
        {
            var list = neighborNumData.numberList;
        ...
        private List<List<byte>> GetResult()
        {
            ...
            var numberDataList = neighborNumData.numberList;
