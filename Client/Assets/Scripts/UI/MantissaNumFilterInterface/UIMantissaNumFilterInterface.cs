...
{
    class UIMantissaNumFilterInterface : UIBase
    {
        ...
        {
            //----------------------------------------------------------------------------
            UIMantissaNumFilterInterface m_parent;
            ...
            //----------------------------------------------------------------------------
            public SumTemp(GameObject go, UIMantissaNumFilterInterface _parent, int numType)
            {
                m_ObjUI = go;
            ...
            public void SetView(int count)
            {
                ...
                m_goRect.sizeDelta += new Vector2(0, count / 15.0f);
            }
            //----------------------------------------------------------------------------
        ...
        {
            base.Show(arg);
            mantissaNumberData = drawData.mantissaNumberData;
        ...
        private void OnBack()
        {
            ...
            Messenger.Broadcast(DgMsgID.DgUI_HideNew, "UIMantissaNumFilterInterfaceCtrl");
        }
        //----------------------------------------------------------------------------
